...
event1 = {
    "queryStringParameters": { "auth": "dayllan:afonso" },
    "body": "{\"key\": \"value\"}"
}
...
print('Teste 1 - Evento de autenticação com credêncial válida : Resultado do teste - ' + autenticacao_bem_sucedida(event1) + '\n')
